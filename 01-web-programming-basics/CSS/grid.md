...
- weekend: nextjs + typescript, redux, tailwind css, prisma, vite, framer sites, figma
- state management theme mode zustand, zod form, prisma mysql, next auth, redux toolkit, tanstack, laravel