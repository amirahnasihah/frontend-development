...
> outer loop repeat, from left to second-last index. inner loop repeat, from left to third-last index. remember: we are comparing neighboring elements so, if current element of subarray > necxt
